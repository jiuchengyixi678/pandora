...
setup(
    ...
    python_requires='>=3.7',
    author='Neo Peng',
    author_email='jiuchengyixi678@gmail.com',
    keywords='OpenAI ChatGPT ChatGPT-Plus gpt-3.5-turbo gpt-3.5-turbo-0301',
    description='A command-line interface to ChatGPT',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/jiuchengyixi678/pandora',
    ...
    project_urls={
        'Source': 'https://github.com/jiuchengyixi678/pandora',
        'Tracker': 'https://github.com/jiuchengyixi678/pandora/issues',
    },
    classifiers=[
