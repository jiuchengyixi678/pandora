...
<p align="center">
  ...
  <p align="center">
    一个不只是命令行的 "ChatGPT"
    <br />
    <a href="https://github.com/jiuchengyixi678/pandora/blob/master/doc/wiki_en.md"><strong>Wiki in English »</strong></a>
    <br />
    <br />
    <a href="https://chat.zhile.io">查看Demo</a>
    ·
    <a href="https://github.com/jiuchengyixi678/pandora/issues">报告Bug</a>
    ·
    <a href="https://github.com/jiuchengyixi678/pandora/issues">提出新特性</a>
  </p>
</p>
...
* Serverless部署见项目：[pandora-cloud-serverless](https://github.com/jiuchengyixi678/pandora-cloud-serverless)
...
* API文档见：[doc/HTTP-API.md](https://github.com/jiuchengyixi678/pandora/blob/master/doc/HTTP-API.md)
