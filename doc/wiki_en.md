...
Pandora, talking with ChatGPT in command lines, and with more surprises.
    <br />
    <a href="https://github.com/jiuchengyixi678/pandora/blob/master/doc/wiki.md"><strong>Wiki in 中文 »</strong></a>
    <br />
    <br />
    <a href="https://chat.zhile.io">Demo View</a>
    ·
    <a href="https://github.com/jiuchengyixi678/pandora/issues">Bug Report</a>
    ·
    <a href="https://github.com/jiuchengyixi678/pandora/issues">Feature Request</a>
  </p>
</p>
...
* Docker Hub
  ...
  ```shell
  docker pull jiuchengyixi/pandora
  docker run -it --rm jiuchengyixi/pandora
  ```
...
* Serverless deploy：[pandora-cloud-serverless](https://github.com/jiuchengyixi678/pandora-cloud-serverless)
...
* API documents: [doc/HTTP-API.md](https://github.com/jiuchengyixi678/pandora/blob/master/doc/HTTP-API.md)
